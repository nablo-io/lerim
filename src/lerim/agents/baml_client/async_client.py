...
class BamlAsyncClient:
    ...
    async def CurateRecordHealthBatch(self, run_instruction: str,batch_id: str,records_json: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(types.ContextCurationPlan, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def ExtractCodingProjectIdentitySlot(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractCodingProjectIdentitySlot", args={
    ...
    async def LinkContextRecords(self, run_instruction: str,cluster_id: str,records_json: str,candidate_pairs_json: str,existing_edges_json: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="LinkContextRecords", args={
    ...
    async def ObserveSourceWindow(self, run_instruction: str,source_profile_context: str,prior_episode_summary: str,prior_findings_summary: str,source_window: str,
        baml_options: BamlCallOptions = {},
    ...
    async def ReviewContextGraphLinks(self, run_instruction: str,records_json: str,proposed_links_json: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ReviewContextGraphLinks", args={
                "run_instruction": run_instruction,"records_json": records_json,"proposed_links_json": proposed_links_json,
            })
            return typing.cast(types.ContextGraphPlan, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def SelectCodingDurableRecords(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,final_records_json: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="SelectCodingDurableRecords", args={
...
class BamlStreamClient:
    ...
    def ExtractCodingProjectIdentitySlot(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.CodingProjectIdentitySlotRecords, types.CodingProjectIdentitySlotRecords]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractCodingProjectIdentitySlot", args={
            "run_instruction": run_instruction,"source_profile_context": source_profile_context,"visible_source_lines": visible_source_lines,
        })
        return baml_py.BamlStream[stream_types.CodingProjectIdentitySlotRecords, types.CodingProjectIdentitySlotRecords](
          __result__,
    ...
    def LinkContextRecords(self, run_instruction: str,cluster_id: str,records_json: str,candidate_pairs_json: str,existing_edges_json: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ContextGraphPlan, types.ContextGraphPlan]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="LinkContextRecords", args={
            "run_instruction": run_instruction,"cluster_id": cluster_id,"records_json": records_json,"candidate_pairs_json": candidate_pairs_json,"existing_edges_json": existing_edges_json,
        })
        return baml_py.BamlStream[stream_types.ContextGraphPlan, types.ContextGraphPlan](
          __result__,
    ...
    def ReviewContextGraphLinks(self, run_instruction: str,records_json: str,proposed_links_json: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ReviewContextGraphLinks", args={
            "run_instruction": run_instruction,"records_json": records_json,"proposed_links_json": proposed_links_json,
        })
        return baml_py.BamlStream[stream_types.ContextGraphPlan, types.ContextGraphPlan](
          __result__,
    ...
    def SelectCodingDurableRecords(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,final_records_json: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.CodingRecordRetentionResult, types.CodingRecordRetentionResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="SelectCodingDurableRecords", args={
            "run_instruction": run_instruction,"source_profile_context": source_profile_context,"visible_source_lines": visible_source_lines,"final_records_json": final_records_json,
        })
        return baml_py.BamlStream[stream_types.CodingRecordRetentionResult, types.CodingRecordRetentionResult](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def ExtractCodingProjectIdentitySlot(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractCodingProjectIdentitySlot", args={
            "run_instruction": run_instruction,"source_profile_context": source_profile_context,"visible_source_lines": visible_source_lines,
        }, mode="request")
        return __result__
    async def ExtractCodingStrategySlots(self, run_instruction: str,source_profile_context: str,user_source_lines: str,durable_findings_summary: str,rejected_findings_summary: str,
    ...
    async def LinkContextRecords(self, run_instruction: str,cluster_id: str,records_json: str,candidate_pairs_json: str,existing_edges_json: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="LinkContextRecords", args={
            "run_instruction": run_instruction,"cluster_id": cluster_id,"records_json": records_json,"candidate_pairs_json": candidate_pairs_json,"existing_edges_json": existing_edges_json,
        }, mode="request")
        return __result__
    async def ObserveSourceWindow(self, run_instruction: str,source_profile_context: str,prior_episode_summary: str,prior_findings_summary: str,source_window: str,
    ...
    async def SelectCodingDurableRecords(self, run_instruction: str,source_profile_context: str,visible_source_lines: str,final_records_json: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SelectCodingDurableRecords", args={
            "run_instruction": run_instruction,"source_profile_context": source_profile_context,"visible_source_lines": visible_source_lines,"final_records_json": final_records_json,
        }, mode="request")
        return __result__
    async def SynthesizeContextRecords(self, run_instruction: str,source_profile_context: str,episode_summary: str,durable_findings_summary: str,existing_record_manifest: str,
