...
class CodingRecordRetentionDecision(BaseModel):
    record_index: typing.Optional[int] = Field(default=None, description='Zero-based index of the candidate durable record in final_records_json.durable_records.')
    keep: typing.Optional[bool] = Field(default=None, description='True only when the record is durable future context rather than current-task implementation debris.')
    reason: typing.Optional[str] = Field(default=None, description='Short reason for keeping or dropping this record.')

class CodingRecordRetentionResult(BaseModel):
    save_any: typing.Optional[bool] = Field(default=None, description='False when the coding session should be archived with no durable records at all.')
    session_reason: typing.Optional[str] = Field(default=None, description='Short session-level reason for saving or dropping all durable records.')
