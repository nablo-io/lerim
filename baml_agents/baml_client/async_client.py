...
class BamlAsyncClient:
    ...
    async def DecideNextExtractStep(self, runtime_dashboard: str,run_instruction: str,tool_manifest: str,scratchpad: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="DecideNextExtractStep", args={
...
class BamlStreamClient:
    ...
    def DecideNextExtractStep(self, runtime_dashboard: str,run_instruction: str,tool_manifest: str,scratchpad: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ExtractAgentStep, types.ExtractAgentStep]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="DecideNextExtractStep", args={
            "runtime_dashboard": runtime_dashboard,"run_instruction": run_instruction,"tool_manifest": tool_manifest,"scratchpad": scratchpad,
        })
        return baml_py.BamlStream[stream_types.ExtractAgentStep, types.ExtractAgentStep](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def DecideNextExtractStep(self, runtime_dashboard: str,run_instruction: str,tool_manifest: str,scratchpad: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DecideNextExtractStep", args={
            "runtime_dashboard": runtime_dashboard,"run_instruction": run_instruction,"tool_manifest": tool_manifest,"scratchpad": scratchpad,
        }, mode="request")
        return __result__
